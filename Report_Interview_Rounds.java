...
import java.io.*;
public class Report_Interview_Rounds
{
  Report_Interview_Rounds(String startdate,String enddate)
  {
    try
    {
      BufferedWriter bw=new BufferedWriter(new FileWriter("Interviews_Rounds.html"));
      bw.write("<html>");
      bw.write("<head>");
      bw.write("<title>"+"Creating Rounds Report"+"</title>");
      bw.write("</head>");
      bw.write("<body>");
      bw.write("<center>");
      bw.write("<h1>"+"Interview Round Wise Qualified Students Transaction Report"+"</h1>"+"<br>"+"<br>");
      ...
      RT.exec("Explorer Interviews_Rounds.html"); 
 }
    catch(IOException E)
    {
      System.out.println("Problems occured during producing Round Wise Qualified Students Report");
    }
  }
}