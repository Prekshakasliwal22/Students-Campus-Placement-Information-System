...
import java.io.*;
public class Report_Selected_Students
{
  Report_Selected_Students(String startdate,String enddate)
  {
    try
    {
      BufferedWriter bw=new BufferedWriter(new FileWriter("Selected_Students.html"));
      bw.write("<html>");
      bw.write("<head>");
      bw.write("<title>"+"Creating Selected Students Report"+"</title>");
      bw.write("</head>");
      bw.write("<body>");
      bw.write("<center>");
      bw.write("<h1>"+"Interview/Company Wise Selected Students Transaction Report"+"</h1>"+"<br>"+"<br>");
      ...
      bw.write("<th>"+"Selection Date"+"</th>");
      bw.write("<th>"+"Company ID No"+"</th>");
      bw.write("<th>"+"Company Name"+"</th>");
      bw.write("<th>"+"Company Address"+"</th>");
      bw.write("<th>"+"No. of Students Selected"+"</th>");
      bw.write("<th>"+"Selected Students PRN"+"</th>");
      bw.write("<th>"+"Additional Information"+"</th>");
      bw.write("</tr>");
      int chk=0;
      BufferedReader br=new BufferedReader(new FileReader("selected_students.dat"));
      String data;
      ...
      RT.exec("Explorer Selected_Students.html"); 
 }
    catch(IOException E)
    {
      System.out.println("Problems occured during producing Interview Wise Selection Report");
    }
  }
}