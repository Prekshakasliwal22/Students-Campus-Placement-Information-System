...
import java.io.*;
public class Report_Scheduled_Interviews
{
  Report_Scheduled_Interviews(String startdate,String enddate)
  {
    try
    {
      BufferedWriter bw=new BufferedWriter(new FileWriter("Schedule_Interviews.html"));
      bw.write("<html>");
      bw.write("<head>");
      ...
      bw.write("<body>");
      bw.write("<center>");
      bw.write("<h1>"+"Scheduled Campus Interviews Transaction Report"+"</h1>"+"<br>"+"<br>");
      ...
      bw.write("<th>"+"Interview Type"+"</th>");
      bw.write("<th>"+"Eligible Branches"+"</th>");
      bw.write("<th>"+"Applicable Criteria"+"</th>");
      bw.write("<th>"+"Off. Designation"+"</th>");
      bw.write("<th>"+"Off. Package"+"</th>");
      bw.write("<th>"+"No. of Vaccancies"+"</th>");
      bw.write("</tr>");
      int chk=0;
      BufferedReader br=new BufferedReader(new FileReader("sch_interviews.dat"));
      String data;
      ...
      RT.exec("Explorer Schedule_Interviews.html"); 
 }
    catch(IOException E)
    {
